...
% Last Modified by GUIDE v2.5 23-Jul-2014 10:43:38
...
% --- Executes on button press in helpOK.
function helpOK_Callback(hObject, eventdata, handles)
% hObject    handle to helpOK (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
close Help;